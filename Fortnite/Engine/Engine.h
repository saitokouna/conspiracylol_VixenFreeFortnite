...
FLinearColor ToLinearColor(FColor Color)
{
	FLinearColor LinearColor;
	LinearColor.A = Color.A / 255.f;
	LinearColor.R = pow(Color.R / 255.f, 2.2f);
	LinearColor.G = pow(Color.G / 255.f, 2.2f);
	LinearColor.B = pow(Color.B / 255.f, 2.2f);
